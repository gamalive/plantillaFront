...
import PuestosModal from "views/Modals/admin/PuestosModal";
...
const Puestos = () => {
    ...
    const updateState = async (item) => {
        let messageToast = 'Puesto ' + (item.estado === 0 ? 'activado' : 'desactivado') + ' correctamente.';
    ...
    return (
        <>
                    ...
                    <div className="col">
                        <Card className="shadow">
                            <CardHeader className="border-0">
                                <h3 className="mb-0">Administración de Puestos<Icon.PlusCircle onClick={() => toggleModal(null, 1)} className="ml-1 cursor-pointer text-green" size={25} style={{ cursor: 'pointer' }} /></h3>
            ...
            <PuestosModal modalOpen={modalOpen} ListRoles={ListRoles} toggleModal={toggleModal} opcion={opcion} information={contentInfor} />
        </>
    );
};
